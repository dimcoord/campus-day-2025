  ...
  return (
    <main className="bg-generic w-screen bg-no-repeat bg-cover">
      ...
      <Card className="max-w-screen md:max-w-[50vw] mx-auto mt-20">
        ...
        <CardContent>
          <div className="flex flex-col space-y-4 md:flex-row justify-between">
            <div>
              <li><Link href="#entre">Entrepeneurship</Link></li>
              <li><Link href="#adaptasi">Adaptasi Perkuliahan</Link></li>
              <li><Link href="#rumpun">Rumpun</Link></li>
            </div>
      ...
      <Card id="entre" className="max-w-screen mx-auto mt-20">
        <CardHeader>
          <CardTitle className='text-2xl'>Entrepreneurship</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card id="adaptasi" className="max-w-screen mx-auto mt-20">
        <CardHeader>
          <CardTitle className='text-2xl'>Adaptasi Perkuliahan</CardTitle>
        </CardHeader>
        <CardContent>
          <p className='text-justify'>
      ...
      <Card id="rumpun" className="max-w-screen mx-auto mt-20">
        <CardHeader>
          <CardTitle className='text-2xl'>Rumpun</CardTitle>
        </CardHeader>
        <CardContent>
          <Accordion 
            type="single" 
